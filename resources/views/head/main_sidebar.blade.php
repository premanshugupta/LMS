<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li>
                    ...
                    <ul>
                        <li> <a class="" href="{{route('add_staff')}}"><i class='fadeIn animated bx bx-plus-circle'></i>Add Staff</a>
                        </li>
                        <li> <a class="" href="{{route('view_staff')}}"><i class='fadeIn animated bx bx-show'></i>View Staff</a>
                        </li>
                        {{-- <li> <a class="" href="javascript:;"><i class='bx bx-radio-circle'></i>Add Staff</a>
                        </li> --}}
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a class="" href="{{route('add_student')}}"><i class='fadeIn animated bx bx-plus-circle'></i>Add Student</a>
                        </li>
                        <li> <a class="" href="{{route('view_student')}}"><i class='fadeIn animated bx bx-show'></i>View Student</a>
                        </li>
                        {{-- <li> <a class="" href="javascript:;"><i class='bx bx-radio-circle'></i>Add Student</a>
                        </li> --}}
                    </ul>
                </li>
                <li>
                    <a class="has-arrow" href="javascript:;">
                        ...
                        <div class="menu-title"><i class="lni lni-user"></i>Batch</div>
                    </a>
                    <ul>
                        <li> <a class="" href="{{route('add_Batch')}}"><i class='fadeIn animated bx bx-plus-circle'></i>Add Batch</a>
                        </li>
        ...
        <li>
            <a href="../../../../external.html?link=https://codervent.com/rocker/documentation/index.html" target="_blank">
        ...
        <li>
            <a href="../../../../external.html?link=https://themeforest.net/user/codervent" target="_blank">
