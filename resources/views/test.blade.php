...
<head>
    ...
    <link
        href="../../../../external.html?link=https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&amp;display=swap"
        rel="stylesheet">
    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="../../../../external.html?link=https://codervent.com/rocker/documentation/index.html"
                        target="_blank">
        ...
        <script>
            ...
            const data = {
                syllabus: "<h5>Syllabus Data</h5><p>This is the syllabus content for your course.</p>",
                class: "<h5>Class Data</h5><p>This is the class information and schedule.</p>",
                lecture: "<h5>Lecture Data</h5><p>This is the lecture material and details.</p>"
            };
        
            // Function to update content area based on the selected tab
